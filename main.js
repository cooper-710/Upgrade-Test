...
const vx = -pitch.vx0 * scale;
const vy = pitch.vz0 * scale;
const vz = pitch.vy0 * scale;

const ax = -pitch.ax * scale * scale;
const ay = pitch.az * scale * scale;
const az = pitch.ay * scale * scale;
