...
document.getElementById("cameraSelect").addEventListener("change", (e) => {
  ...
  switch(view) {
    ...
    case "pitcher":
      ...
      break;
    case "rhh":
      camera.position.set(1, 4.5, -64);  // higher right-handed hitter view
      camera.lookAt(0, 4, 0);           // look at pitcher
      break;
    case "lhh":
      camera.position.set(-1, 4.5, -64); // higher left-handed hitter view
      camera.lookAt(0, 4, 0);           // look at pitcher
      break;
    case "1b":
