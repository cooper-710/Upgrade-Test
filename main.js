  ...
  if (playing) {
    ...
    for (let ball of balls) {
      ...
      if (!ball.userData.frozen && t >= ball.userData.timeToPlate) {
        ...
        ball.position.x = release.x + velocity.x * tFinal + 0.5 * accel.x * tFinal * tFinal;
        ball.position.y = release.y + velocity.y * tFinal + 0.5 * accel.y * tFinal * tFinal;
        ball.position.z = release.z + velocity.z * tFinal + 0.5 * accel.z * tFinal * tFinal;
      }
